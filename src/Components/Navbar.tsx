...
function NavBar({ cartCount, cartItems, cartOpen, setCartOpen, removeFromCart }: NavBarProps) {
                ...
                <div className="fixed inset-0 z-[100]">
                    ...
                    <div className="absolute right-0 top-0 h-full w-[280px] md:w-[350px] bg-white shadow-xl px-7
                     md:px-10 py-7 overflow-y-auto">
                        ...
                        <div className="mt-10">
                            {cartItems.length === 0 ? 
                            <p className="text-center mx-5 py-2 bg-[#DFDDD8] font-semibold animate__animated animate__pulse">Your cart is empty</p> : 
                            (
