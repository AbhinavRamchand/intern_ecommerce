...
function Trends() {
  ...
  return (
    ...
    >
      ...
      <h1
        className={`mx-5 mt-10 text-3xl font-bold transition-colors duration-500 ${
      ...
      <section className="grid grid-cols-1 gap-6 px-6 py-8 sm:grid-cols-2 lg:grid-cols-4">

        {products.map((product) => (
          <div
            key={product.title}
            className={`group mx-auto w-full overflow-hidden transition-all duration-500 ${
              darkMode
