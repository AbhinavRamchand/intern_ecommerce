...
function About() {
    ...
    return (
        <>
            ...
            <div
                className="relative w-full h-[250px] md:h-[400px] lg:h-[500px] bg-cover md:bg-center bg-no-repeat"
                style={{
                    backgroundImage:
                        "url('https://images5.alphacoders.com/364/364727.jpg')"
                }}
            >
                ...
                <div className="relative z-10 h-full flex flex-col justify-center items-center
                 text-white gap-1 md:gap-4 animate__animated animate__fadeInDown animate__slow">
                    ...
                    <p className="text-white/70 text-md sm:text-xl">
            ...
            <div
                className={`transition-colors duration-500 ${
                    darkMode
                        ...
                        : "bg-[#EAE9E5] text-gray-900"
                }`}
            >

                <ScrollAnimation animation="animate__zoomIn" speed="slow">

                    <p className="py-5 text-center text-[9px] md:text-[12px] font-semibold">
                        TIMELESS LUXURY, MODERN DESIGN & ELEVATED STYLE — CURATED FOR YOU.
                    </p>
            ...
            >
                ...
                <ScrollAnimation speed="slow">
                    ...
                    <div className="flex flex-col md:flex-row w-[85%] mx-auto  py-10  md:py-20 mb-[150px] gap-[85px]">

                        <div className="w-full md:w-[58%]">

                            <h2
                                className={`mb-3 font-bold text-[24px] ${
                                    darkMode
                                        ? "text-[#C8B6A6]"
                                        : "text-[#7E6A5A]"
                                }`}
                            ...
                            <p
                                className={`leading-6 text-[14px] text-justify ${
                                    darkMode
                                        ? "text-gray-400"
                                        : "text-gray-500"
                                }`}
                            >
                                Curate is a fashion destination
                                ...
                                With Curate, discovering your perfect style becomes effortless.
                                ...
                                and fit effortlessly into your everyday life.

                                <br />
                                <br />

                                Experiment with new looks, embrace your individuality, and make every outfit meaningful.
                                ...
                                >
                                    Create a wardrobe that celebrates your individuality and inspires
                                    you to feel confident every day. Let Curate be part of your journey toward effortless, personal style.
                                </span>

                                Find your signature style with Curate and make every look your own.
                        ...
                        <div className="relative w-[300px] md:w-[400px] h-[350px] mx-auto">
                            ...
                            <div
                                className={`absolute left-[-25px] top-[25px] w-full h-full border-2 ${
                                    darkMode
                                        ? "border-gray-700"
                                        : "border-gray-300"
                                }`}
                ...
                <ScrollAnimation speed="slow">
                    ...
                    <div className="flex flex-col md:flex-row w-[85%] mx-auto  py-20 gap-[85px]">

                       
                        <div className="relative order-2 md:order-1 w-[300px] md:w-[400px] h-[350px] mx-auto">

                            <div
                                className={`absolute right-[-25px] top-[25px] w-full h-full border-2 ${
                                    darkMode
                                        ? "border-gray-700"
                                        : "border-gray-300"
                                }`}
                        ...
                        <div className="w-full md:w-[58%] order-1 md:order-2">
                            ...
                            >
                                Our mission is to make fashion feel effortless,
                            ...
                            <div className="flex gap-6 mt-10">
                                ...
                                <div>
                                    ...
                                    <p
                                        className={` mb-5  leading-6 text-[16px] italic ${
                                            darkMode
                                                ? "text-gray-400"
                                                : "text-gray-500"
                                        }`}
                                    >
                                        Style is not about following every trend; it is about discovering what feels right for you.
                                        The best outfits are the ones that reflect your personality, give you confidence, and make you feel completely yourself.
                                    </p>
